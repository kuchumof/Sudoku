...
## Задача
1. Механизм создания случайных игровых досок;
2. Механизм для проверки решения судоку;
3. Механизм для присвоения доскам уровня сложности;
4. Механизм для сохранения пользовательского игрового процесса;
